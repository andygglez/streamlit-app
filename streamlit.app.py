...
st.title('Comparing changes of different histone marks with gene expression changes -- main')
...
#         colorscale='Picnic',         # Choose a colormap
#         colorbar=dict(title='tpm_Parental'),  # Add color legend
#         showscale=True,
#         cmin=color_min, cmax=color_max
#     )
# )
...
#         colorscale='Picnic',         # Choose a colormap
#         colorbar=dict(title='tpm_NSD1KO'),  # Add color legend
#         showscale=True,
#         cmin=color_min, cmax=color_max
#     )
# )
